...
# automated testing using assignment-autotest.  It automates the steps 
# described in https://github.com/cu-ecen-5013/assignment-autotest/blob/master/README.md#running-tests
set -e
